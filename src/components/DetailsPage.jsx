...
function DetailsPage() {
  ...
  return (
    <div className="outer box-border w-screen h-screen bg-red-200 pt-2">
      <div className="details box-border w-3/4 sm:w-1/2 h-4/6 bg-white mx-auto mt-32 p-4 rounded-xl flex flex-col items-start justify-evenly">
