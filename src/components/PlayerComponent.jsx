...
function PlayerComponent({ playerOneName, playerTwoName, setIntialValues }) {
  ...
  return (
    <div className="details box-border w-3/4 bg-slate-100 flex flex-col items-center justify-center gap-2 my-4 py-2 rounded-xl">
      ...
      <div className="buttonDiv  box-border w-full flex items-center justify-center gap-4 mt-5 ">
        <button
          className="reset box-border w-fit sm:w-2/5 bg-green-400 px-3 py-1 mt-2 rounded-xl text-lg text-center hover:ring-2 ring-offset-2 ring-blue-600"
          onClick={() => {
            navigate("/");
          }}
        >
        ...
        <button
          className="restart box-border w-fit sm:w-2/5 bg-green-400 px-3 py-1 mt-2 rounded-xl text-lg text-center hover:ring-2 ring-offset-2 ring-blue-600"
          onClick={() => {
